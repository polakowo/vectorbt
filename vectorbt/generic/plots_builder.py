...
class PlotsBuilderMixin(metaclass=MetaPlotsBuilderMixin):
    ...
    _subplots: tp.ClassVar[Config] = Config(dict(), copy_kwargs=dict(copy_mode="deep"))
        ...
        **layout_kwargs,
        ...
        sub_layout_kwargs = merge_dicts(
            dict(
                ...
                width=width,
                height=height,
                legend=dict(orientation="h", yanchor="bottom", y=legend_y, xanchor="right", x=1, traceorder="normal"),
            ),
            sub_layout_kwargs,
        )
