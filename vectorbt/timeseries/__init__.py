...
@accessors.register_dataframe_accessor('timeseries')
class TimeSeries_DFAccessor(TimeSeries_Accessor, utils.Base_DFAccessor):
...
@accessors.register_series_accessor('timeseries')
class TimeSeries_SRAccessor(TimeSeries_Accessor, utils.Base_SRAccessor):
...
@accessors.register_dataframe_accessor('ohlcv')
