"""Modules for working with OHLCV data.

You can access methods listed in `vectorbt.ohlcv` as follows:

* `vectorbt.ohlcv.OHLCV_DFAccessor` -> `pd.DataFrame.vbt.ohlcv`
...
from vectorbt.accessors import register_dataframe_accessor
