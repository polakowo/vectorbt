...
@accessors.register_dataframe_accessor('signals')
class Signals_DFAccessor(Signals_Accessor, utils.Base_DFAccessor):

    @classmethod
    def empty(cls, *args, fill_value=False, **kwargs):
        return utils.Base_DFAccessor.empty(*args, fill_value=fill_value, **kwargs)

    @classmethod
    def empty_like(cls, *args, fill_value=False, **kwargs):
        return utils.Base_DFAccessor.empty_like(*args, fill_value=fill_value, **kwargs)
...
@accessors.register_series_accessor('signals')
class Signals_SRAccessor(Signals_Accessor, utils.Base_SRAccessor):

    @classmethod
    def empty(cls, *args, fill_value=False, **kwargs):
        return utils.Base_SRAccessor.empty(*args, fill_value=fill_value, **kwargs)

    @classmethod
    def empty_like(cls, *args, fill_value=False, **kwargs):
        return utils.Base_SRAccessor.empty_like(*args, fill_value=fill_value, **kwargs)
