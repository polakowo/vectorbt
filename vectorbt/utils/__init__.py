...
from vectorbt.utils import checks, combine_fns, common, index_fns, indexing, reshape_fns

from vectorbt.utils.reshape_fns import broadcast_defaults
...
class Base_Accessor():
    ...
    @common.class_or_instancemethod
