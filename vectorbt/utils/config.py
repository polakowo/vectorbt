...
class Config(PickleableDict, Documented):
    ...
    def __init__(
        ...
        as_attrs: tp.Optional[bool] = None,
    ) -> None:
        try:
    ...
    def merge_with(self: ConfigT, other: InConfigLikeT, nested: tp.Optional[bool] = None, **kwargs) -> OutConfigLikeT:
