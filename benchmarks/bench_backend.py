...
def make_cases(a: np.ndarray, window: int, seed: int) -> list[BenchmarkCase]:
    ...
    cases = [
        ...
        BenchmarkCase("set_by_mask_1d", nb.set_by_mask_1d_nb, (a_1d, mask_1d, -1.0), rust_generic.set_by_mask_1d_rs, (a_1d, mask_1d, -1.0)),
        BenchmarkCase("set_by_mask", nb.set_by_mask_nb, (a, mask, -1.0), rust_generic.set_by_mask_rs, (a, mask, -1.0)),
        BenchmarkCase("set_by_mask_mult_1d", nb.set_by_mask_mult_1d_nb, (a_1d, mask_1d, values_1d), rust_generic.set_by_mask_mult_1d_rs, (a_1d, mask_1d, values_1d)),
        BenchmarkCase("set_by_mask_mult", nb.set_by_mask_mult_nb, (a, mask, values), rust_generic.set_by_mask_mult_rs, (a, mask, values)),
        ...
        BenchmarkCase("rolling_min_1d", nb.rolling_min_1d_nb, (a_1d, window, None), rust_generic.rolling_min_1d_rs, (a_1d, window, None)),
        BenchmarkCase("rolling_min", nb.rolling_min_nb, (a, window, None), rust_generic.rolling_min_rs, (a, window, None)),
        BenchmarkCase("rolling_max_1d", nb.rolling_max_1d_nb, (a_1d, window, None), rust_generic.rolling_max_1d_rs, (a_1d, window, None)),
        BenchmarkCase("rolling_max", nb.rolling_max_nb, (a, window, None), rust_generic.rolling_max_rs, (a, window, None)),
        BenchmarkCase("rolling_mean_1d", nb.rolling_mean_1d_nb, (a_1d, window, None), rust_generic.rolling_mean_1d_rs, (a_1d, window, None)),
        BenchmarkCase("rolling_mean", nb.rolling_mean_nb, (a, window, None), rust_generic.rolling_mean_rs, (a, window, None)),
        BenchmarkCase("rolling_std_1d", nb.rolling_std_1d_nb, (a_1d, window, None, 0), rust_generic.rolling_std_1d_rs, (a_1d, window, None, 0)),
        BenchmarkCase("rolling_std", nb.rolling_std_nb, (a, window, None, 0), rust_generic.rolling_std_rs, (a, window, None, 0)),
        BenchmarkCase("ewm_mean_1d", nb.ewm_mean_1d_nb, (a_1d, window, 0, False), rust_generic.ewm_mean_1d_rs, (a_1d, window, 0, False)),
        BenchmarkCase("ewm_mean", nb.ewm_mean_nb, (a, window, 0, False), rust_generic.ewm_mean_rs, (a, window, 0, False)),
        BenchmarkCase("ewm_std_1d", nb.ewm_std_1d_nb, (a_1d, window, 0, False, 0), rust_generic.ewm_std_1d_rs, (a_1d, window, 0, False, 0)),
        BenchmarkCase("ewm_std", nb.ewm_std_nb, (a, window, 0, False, 0), rust_generic.ewm_std_rs, (a, window, 0, False, 0)),
        BenchmarkCase("expanding_min_1d", nb.expanding_min_1d_nb, (a_1d, 1), rust_generic.expanding_min_1d_rs, (a_1d, 1)),
        BenchmarkCase("expanding_min", nb.expanding_min_nb, (a, 1), rust_generic.expanding_min_rs, (a, 1)),
        BenchmarkCase("expanding_max_1d", nb.expanding_max_1d_nb, (a_1d, 1), rust_generic.expanding_max_1d_rs, (a_1d, 1)),
        BenchmarkCase("expanding_max", nb.expanding_max_nb, (a, 1), rust_generic.expanding_max_rs, (a, 1)),
        BenchmarkCase("expanding_mean_1d", nb.expanding_mean_1d_nb, (a_1d, 1), rust_generic.expanding_mean_1d_rs, (a_1d, 1)),
        BenchmarkCase("expanding_mean", nb.expanding_mean_nb, (a, 1), rust_generic.expanding_mean_rs, (a, 1)),
        BenchmarkCase("expanding_std_1d", nb.expanding_std_1d_nb, (a_1d, 1, 0), rust_generic.expanding_std_1d_rs, (a_1d, 1, 0)),
        ...
        BenchmarkCase("flatten_grouped", nb.flatten_grouped_nb, (a, group_lens, False), rust_generic.flatten_grouped_rs, (a, group_lens, False)),
        BenchmarkCase("flatten_uniform_grouped", nb.flatten_uniform_grouped_nb, (a, uniform_group_lens, True), rust_generic.flatten_uniform_grouped_rs, (a, uniform_group_lens, True)),
        BenchmarkCase("nth_reduce", nb.nth_reduce_nb, (0, a_1d, -1), rust_generic.nth_reduce_rs, (a_1d, -1)),
        BenchmarkCase("nth_index_reduce", nb.nth_index_reduce_nb, (0, a_1d, -1), rust_generic.nth_index_reduce_rs, (a_1d, -1)),
        ...
        BenchmarkCase("describe_reduce", nb.describe_reduce_nb, (0, a_1d, perc, 0), rust_generic.describe_reduce_rs, (a_1d, perc, 0)),
        BenchmarkCase("value_counts", nb.value_counts_nb, (codes, 5, group_lens), rust_generic.value_counts_rs, (codes, 5, group_lens)),
        ...
        BenchmarkCase("range_duration", nb.range_duration_nb, (range_start, range_end, range_status), rust_generic.range_duration_rs, (range_start, range_end, range_status)),
        BenchmarkCase("range_coverage", nb.range_coverage_nb, (range_start, range_end, range_status, col_map, index_lens, False, False), rust_generic.range_coverage_rs, (range_start, range_end, range_status, col_map, index_lens, False, False)),
        BenchmarkCase("ranges_to_mask", nb.ranges_to_mask_nb, (range_start, range_end, range_status, col_map, a.shape[0]), rust_generic.ranges_to_mask_rs, (range_start, range_end, range_status, col_map, a.shape[0])),
        BenchmarkCase("get_drawdowns", nb.get_drawdowns_nb, (a,), rust_generic.get_drawdowns_rs, (a,)),
        BenchmarkCase("dd_drawdown", nb.dd_drawdown_nb, (peak_val, valley_val), rust_generic.dd_drawdown_rs, (peak_val, valley_val)),
        BenchmarkCase("dd_decline_duration", nb.dd_decline_duration_nb, (start_idx, valley_idx), rust_generic.dd_decline_duration_rs, (start_idx, valley_idx)),
        BenchmarkCase("dd_recovery_duration", nb.dd_recovery_duration_nb, (valley_idx, end_idx), rust_generic.dd_recovery_duration_rs, (valley_idx, end_idx)),
        BenchmarkCase("dd_recovery_duration_ratio", nb.dd_recovery_duration_ratio_nb, (start_idx, valley_idx, end_idx), rust_generic.dd_recovery_duration_ratio_rs, (start_idx, valley_idx, end_idx)),
        BenchmarkCase("dd_recovery_return", nb.dd_recovery_return_nb, (valley_val, end_val), rust_generic.dd_recovery_return_rs, (valley_val, end_val)),
